...
export default function FooterMenu() {
  ...
  return (
    <div className="grid grid-cols-1 gap-8 md:gap-0 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
      {lastMenu
                ...
                <ul className="space-y-4 text-sm">
                  {lastMenu.name !== menu.name
                    ...
                    : menu.submenu.map(sub => (
                        <li
                          key={sub.name}
                          className="flex items-start justify-center gap-1.5 sm:justify-start group"
                        >
                          {sub.icon}
                          <span className="text-white transition cursor-pointer group-hover:text-white/75">
                            {sub.name}
                          </span>
                        </li>
                      ))}
